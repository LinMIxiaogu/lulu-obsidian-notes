...
| 课程                              | 主题              | 格言                                |
| ------------------------------- | --------------- | --------------------------------- |
| [[s01-agent-loop]]              | Agent 循环        | *One loop & Bash is all you need* |
| [[s02-tool-use]]                | Tool Use        | *加一个工具, 只加一个 handler*             |
| [[s03-todo-write]]              | TodoWrite       | *没有计划的 agent 走哪算哪*                |
| [[s04-subagent]]                | 子智能体            | *大任务拆小, 每个小任务干净的上下文*              |
| [[s05-skill-loading]]           | Skills          | *用到什么知识, 临时加载什么知识*                |
| [[s06-context-compact]]         | Context Compact | *上下文总会满, 要有办法腾地方*                 |
| [[s07-task-system]]             | 任务系统            | *大目标要拆成小任务, 排好序, 记在磁盘上*           |
| [[s08-background-tasks]]        | 后台任务            | *慢操作丢后台, agent 继续想下一步*            |
| [[s09-agent-teams]]             | 智能体团队           | *任务太大一个人干不完, 要能分给队友*              |
| [[s10-team-protocols]]          | 团队协议            | *队友之间要有统一的沟通规矩*                   |
| [[s11-autonomous-agents]]       | 自治智能体           | *队友自己看看板, 有活就认领*                  |
| [[s12-worktree-task-isolation]] | Worktree + 任务隔离 | *各干各的目录, 互不干扰*                    |
